    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary shadow-sm">
        <div class="container">
            ...
            <div class="collapse d-lg-flex justify-content-end navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../../rentalmobil/login">Login<span class="visually-hidden"></span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../../rentalmobil/register">Daftar<span class="visually-hidden"></span></a>
                    </li>
                </ul>
            </div>
        </div>
